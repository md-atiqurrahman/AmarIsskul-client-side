...
const OurAchievement = () => {
  ...
  return (
    <div className="dark-effect bg-[url('/src/assets/home/OurAchievement/achivement-bg.png')] bg-cover bg-center bg-no-repeat bg-fixed pt-[100px] px-[120px] pb-[70px] z-[2] relative text-white overflow-hidden">
