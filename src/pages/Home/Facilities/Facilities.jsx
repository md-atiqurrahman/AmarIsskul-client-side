...
import slate from "../../../assets/Facilities/heading-slate-gray.png";
...
const Facilities = () => {
  ...
  return (
    <div className="facilities-area bg-[url('/src/assets/Facilities/facilities-bg.png')] bg-cover bg-center bg-no-repeat bg-fixed pt-[100px] z-[2]  relative text-white overflow-hidden">
      <div className="flex justify-center">
        <div
          className="flex justify-center items-center gap-[30px] border-primary border-b-[3px]" style={{width: `${width}`}}
        >
          <img className="w-[35px] h-[36px]" src={slate} alt="Slate" />
          <h1 className="text-[50px] leading-[54px] font-medium">
            {t("facilities.sectionTitle")}
          </h1>
        </div>
      </div>
      <div className="flex flex-col lg:flex-row justify-center items-center gap-[74px] relative pb-[100px] mt-[140px]">
